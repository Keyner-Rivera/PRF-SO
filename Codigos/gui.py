...
"""
feat: agregar cuadro de diálogo de error personalizado con estilo moderno
ui: implementar CustomErrorDialog con mensaje y botón aceptar
style: aplicar colores oscuros y botón rojo en el diálogo de error
fix: centralizar mensaje y ajustar tamaño automático del diálogo
refactor: encapsular lógica de errores en clase CustomErrorDialog
"""
